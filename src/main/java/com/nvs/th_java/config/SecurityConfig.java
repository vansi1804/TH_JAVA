package com.nvs.th_java.config;

import com.nvs.th_java.service.UserService;
import com.nvs.th_java.service.impl.UserServiceImpl;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return new UserServiceImpl(); // Cung cấp dịch vụ xử lý chi tiết người dùng.
    }
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/register", "/error", "/products", "/cart", "/cart/**")
                ...
                .httpBasic(httpBasic -> httpBasic
                        .realmName("nvs") // Tên miền cho xác thực cơ bản.
                )
